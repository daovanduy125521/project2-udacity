        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM order_product_table";
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Cannot get all order_products. Error: ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderProductStore.prototype.find = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT * FROM order_product_table WHERE id=($1);';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
