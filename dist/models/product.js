...
var ProductsStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Cannot get all products. Error: ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductsStore.prototype.find = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductsStore.prototype.create = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [body.name, body.price])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not add new product ".concat(body.name, ". Error: ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
