...
var find = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.find(req.params.id)];
            case 1:
                user = _a.sent();
                res.json({ user: user });
                return [2 /*return*/];
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, userAuthen, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = {
            ...
            case 2:
                ...
                if (userAuthen) {
                    token = jsonwebtoken_1.default.sign({ user: userAuthen }, process.env.JWT_TOKEN_SECRET);
                    res.json(token);
                }
                else {
                    res.status(400);
...
var users_routers = function (app) {
    app.get('/users', verifyAuthToken_1.default, index);
    app.get('/users/:id', verifyAuthToken_1.default, find);
    app.post('/users', create);
    app.post('/users/login', authenticate);
};
exports.default = users_routers;
